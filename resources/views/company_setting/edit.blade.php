...
@section('extra_css')
    <style>
        .daterangepicker .drp_calendar.left{
...
@section('content')
   <div class="card">
        <div class="card-body">
            <form action="{{route('company_setting.update',1)}}" method="post" autocomplete="off" id="edit-form" enctype="multipart/form-data">  {{-- autocomplete="off" => no suggestion in chrome --}}
                @csrf
                @method('PUT')
                        <div class="md-form">
                        ...
                        <div class="md-form">
                            ...
                            <textarea name="company_address" class="md-textarea form-control pt-3">{{$setting->company_address}}</textarea>
                        </div>
                        <div class="md-form">
